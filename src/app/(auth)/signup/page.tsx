...
function firebaseAuthErrorMessage(err: any): string {
  ...
  if (code === 'auth/wrong-password' || code === 'auth/invalid-credential') return 'Incorrect password for this email. Please try again or use “Sign In”.';
        ...
        <form onSubmit={handleBasicInfoSubmit} className="animate-pop-in space-y-4" style={{ animationDelay: '0.2s' }}>
            <div className="grid gap-2 text-left">
                ...
                <div className="relative">
                    ...
                    <Input id="fullname" type="text" placeholder="Enter full name" required className="pl-10" value={fullName} onChange={(e) => setFullName(e.target.value)}/>
                </div>
            </div>
             <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2 text-left">
                    ...
                    <div className="relative">
                        ...
                        <Input id="age" type="number" placeholder="Enter age" required className="pl-10" value={age} onChange={(e) => setAge(e.target.value)} />
                    </div>
                </div>
                <div className="grid gap-2 text-left">
             ...
             <div className="grid gap-2 text-left">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative flex-1">
                      ...
                      <Input id="email" type="email" placeholder="Enter email" required className="pl-10" value={email} onChange={(e) => setEmail(e.target.value)} />
                  </div>
                  <Button
                    type="button"
                    variant="outline"
            ...
            <Button variant="gradient" size="lg" className="w-full text-lg font-bold" type="submit" disabled={!emailVerified}>
